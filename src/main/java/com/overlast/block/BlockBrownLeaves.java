...
public class BlockBrownLeaves extends BlockColoredLeaves  {

	/*
	 * Orange dark oak leaves for Autumn. Bit messed up. But otherwise fine.
	 */

	public final String name = "brown_leaves";

	public BlockBrownLeaves() {
	...
	public List<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
		...
		list.add(new ItemStack(ModBlocks.BROWN_LEAVES));
		return list;
	}
