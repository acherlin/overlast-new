...
public class OverLast {
	...
	public static final String DEPENDENCIES = "required-after:forge@[14.23.1.2611,);required-after:srparasites@[1.10.7,);after:sereneseasons;after:playerrevive;after:cgm;after:dynamicstealth;after:spartanshields;after:lostcities;after:apexguns;after:crafttweaker";
