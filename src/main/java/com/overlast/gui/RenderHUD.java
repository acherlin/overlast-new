...
public class RenderHUD extends Gui {
	...
	public static void retrieveStats(boolean hide,int phase, int evolution,boolean showRequestDirtyClock) {
		hideUI=hide;
		EvoIndex=phase;
		...
		switch(phase) {
			...
			case 7:EVOLUTION_BAR.setMaxValue(SRPConfigSystems.phaseKillsEight);break;
			case 8:EVOLUTION_BAR.setMaxValue(SRPConfigSystems.phaseKillsNine);break;
			case 9:
			case 10:
				EVOLUTION_BAR.setMaxValue(SRPConfigSystems.phaseKillsTen);break;
		}
